...
export default function About() {
  return (
    <div id="about">
      <div className="about-split" style={{ display: 'block', maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <div className="about-text-side">
          ...
          <Link to="/contact" className="btn-accent" style={{ marginTop: '1rem', width: 'fit-content', display: 'inline-block', textDecoration: 'none', marginLeft: 'auto', marginRight: 'auto' }}>Get in Touch</Link>
        </div>
      </div>
